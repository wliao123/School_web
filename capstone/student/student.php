      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item px-2">
            <a href="http://weblab.salemstate.edu/~capstonesignup/student/student.php" class="nav-link active">Home</a>
          </li>
    ...
    ?>
      ...
      <?php   
           ...
           if($exists > 0) {
               ...
               echo "<h2>You have signed up. <br>You can view it in '<a href='http://weblab.salemstate.edu/~capstonesignup/student/myproject.php'>My Project</a>'.<br>Good Luck!</h2> ";         
           }else{
               
                echo "<h2>You have not signed up yet.<br>
                  </h2>  ";
